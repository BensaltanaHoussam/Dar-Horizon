<x-app-layout>
    ...
    <!-- Edit Modal -->
    <div id="editPropertyModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title"
        role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <!-- Background overlay -->
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"
                onclick="document.getElementById('editPropertyModal').classList.add('hidden')"></div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            <div class="flex justify-between items-center border-b pb-4 mb-4">
                                ...
                                <button type="button" class="text-gray-400 hover:text-gray-500"
                                    onclick="document.getElementById('editPropertyModal').classList.add('hidden')">
                            ...
                            <form action="{{ route('listings.update', $listing->id) }}" method="POST"
                                ...
                                < <!-- Title -->
                                    <div class="space-y-2">
                                        <label for="title" class="block text-sm font-medium text-gray-700">Property
                                            Title
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <select id="country" name="country"
                                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
                                            required>
                                            <option value="Portugal" {{ old('country', $listing->country) == 'Portugal' ? 'selected' : '' }}>Portugal</option>
                                            <option value="Morocco" {{ old('country', $listing->country) == 'Morocco' ? 'selected' : '' }}>Morocco</option>
                                            <option value="Spain" {{ old('country', $listing->country) == 'Spain' ? 'selected' : '' }}>Spain</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="number" id="price" name="price"
                                            value="{{ old('price', $listing->price) }}" min="1" placeholder="150"
                                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
                                            required>
                                    </div>
                                        ...
                                        @if ($listing->image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $listing->image) }}"
                                                    alt="Current Property Image" class="w-1/2 rounded-md">
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input type="date" id="available_until" name="available_until"
                                                value="{{ old('available_until', $listing->available_until) }}"
                                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors"
                                                required>
                                        </div>
                                    </div>
